...
export const metadata = {
    title: "Contact Me",
    description: `Contact me through the form available here or email me  at ${siteMetadata.email}`,
}
...
export default function Contact(){
    ...
    <LottieAnimation />
        ...
        <div className=" w-full md:w-3/5 flex flex-col items-start justify-center px-5 xs:px-10md:px-16 pb-8 ">
